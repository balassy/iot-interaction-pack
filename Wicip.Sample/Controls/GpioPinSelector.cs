	...
	public class GpioPinSelector : ComboBox
	{
		public GpioPinSelector()
		{
			...
			this.ItemsSource = new List<KeyValuePair<string, int>>
			{
				...
				new KeyValuePair<string, int>("GPIO 14 - pin 08 (UART_TXD)", 14),
				new KeyValuePair<string, int>("GPIO 15 - pin 10 (UART_RXD)", 15),
				new KeyValuePair<string, int>("GPIO 16 - pin 36", 16),
