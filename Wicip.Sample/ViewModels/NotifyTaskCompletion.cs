// The majority of the code in this file is copied from Stephen Cleary's AsyncEx library to support asynchronous data binding.
// Please check the full AsyncEx project on Github as it contains tons of useful types: https://github.com/StephenCleary/AsyncEx
// The full NuGet package is not used to avoid strong-naming issues in AppVeyor.
...
namespace Wicip.Sample.ViewModels
{
	...
	public static class NotifyTaskCompletion
	{
		...
		[SuppressMessage( "Microsoft.Design", "CA1062:Validate arguments of public methods", MessageId = "0", Justification = "Third-party code" )]
		...
		/// <returns>A new task notifier watching the returned task.</returns>
		[SuppressMessage( "Microsoft.Design", "CA1062:Validate arguments of public methods", MessageId = "0", Justification = "Third-party code" )]
		[SuppressMessage( "Microsoft.Design", "CA1006:DoNotNestGenericTypesInMemberSignatures", Justification = "Third-party code" )]
